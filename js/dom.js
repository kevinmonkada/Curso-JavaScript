...
$linkDOM.setAttribute("rel", "noopener"); //Buena practica hacer esto cada que se agrega una blank target
...
$linkDOM.setAttribute("data-description", "Modelo de Objetos del Document");
console.log($linkDOM.dataset.description);
$linkDOM.dataset.description = "Ven a buscar en google lo que quieras";
console.log($linkDOM.dataset.description);
...
//Variables CSS - Customer Properties CSS
...
`;
//$whatIsDOM.innerText = text; no es buena practica
$whatIsDOM.textContent = text; este me crasheo el navegador
$whatIsDOM.innerHTML = text; funciona bien
$whatIsDOM.outerHTML = text; funciona bien tambien */
/*
...
$img.setAttribute("src", "https://unsplash.it/200/200/?random=6");
...
$figure2.innerHTML = `
<img src= "https://unsplash.it/200/200/?random=7" alt="People">
...
document.write("<h3>Contenintes del Mundo</h3>");
...
//forma mas optima y que consume menos recursos, es mejor trabajar con fragmentos
meses.forEach((el) => {
	const $li = document.createElement("li");
	$li.innerHTML = el;
...
/* const $cards = document.querySelector(".cards"),
	...
	cardcontent = [
		{
			title: "Tecnología",
			img: "https://unsplash.it/200/200/?random=1",
		},
		{
			title: "Animales",
			img: "https://unsplash.it/200/200/?random=2",
		},
		{
			title: "Arquitectura",
			img: "https://unsplash.it/200/200/?random=3",
		},
		{
			title: "Gente",
			img: "https://unsplash.it/200/200/?random=4",
		},
		{
			title: "Naturaleza",
			img: "https://unsplash.it/200/200/?random=5",
		},
	];
...
$newCard.innerHTML = `
  <img src="https://unsplash.it/200/200/?random=1" alt="Test">
...
//La expresion regular excluse valores no alfanumericos y concluye el ejercicio, el loop for ayuda a recorrer cada letra para contrarlas y calcular si es true o false
/* var isPalindrome = function (s) {
	const lowerS = s.replace(/[\W_]+/g, "").toLowerCase();
...
console.log(isPalindrome("azucar"));
console.log("Test");
 */
